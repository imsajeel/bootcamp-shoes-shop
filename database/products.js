export const products = [
  ...
  },
  {
    ...
    price: '$160',
    category: 'Men\'s Running Shoe',
    description: '<p>The Nike React Infinity Run Flyknit is designed to help reduce injury and keep you on the run. More foam and improved upper details provide a secure and cushioned feel. Lace up and feel the potential as you hit the road.</p><ul class="description-preview__features pt8-sm pb6-sm ncss-list-ul"><li class="description-preview__color-description ncss-li">Shown: True White/White/Pure Platinum/Photo Blue</li><li class="description-preview__style-color ncss-li">Style: CD4371-101</li></ul>',
    images: [
